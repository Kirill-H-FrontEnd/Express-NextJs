    ...
    <>
          ...
          <>
            <div className="grid gap-6 ">
              <p>
                ...
                and Express.ts for additional features and optimizations.
              </p>
              <p>
              ...
              <p>
                ...
                Express.ts can help you build interactive, dynamic, and fast
                React applications.
              </p>
            </div>
          </>
          ...
          <>
            <div className="grid gap-6 ">
              <p>
                ...
                application. However, you can read them in any order or skip to
                the pages that apply to your use case.
              </p>
              <p>
                ...
                the top, or the search shortcut (
      ...
      <TitleBanner
        ...
        content={
          <>
            <div className="grid gap-6 ">
              <p>
                Next.js has two different routers: the App Router and the Pages
                Router. The App Router is a newer router that allows you to use
                React's latest features, such as Server Components and
              ...
              <p>
                ...
                allows you to switch between the <strong>App Router</strong> and
                the <strong>Pages Router</strong> features. Since there are
                features that are unique to each directory, it's important to
      ...
      <TitleBanner
        ...
        content={
          <>
            <div className="grid gap-6 ">
              <p>
                Although our docs are designed to be beginner-friendly, we need
                to establish a baseline so that the docs can stay focused on
                Next.js functionality. We'll make sure to provide links to
                relevant documentation whenever we introduce a new concept.
              </p>
              <p>
                To get the most out of our docs, it's recommended that you have
                a basic understanding of HTML, CSS, and React. If you need to
                brush up on your React skills, check out our{" "}
                <Link className="text-purple-800" href={""}>
                  React Foundations Course
                </Link>
                , which will introduce you to the fundamentals. Then, learn more
                about Next.js by{" "}
                <Link className="text-purple-800" href={""}>
      ...
      <TitleBanner
        ...
        content={
          <>
            <p>
              For optimal accessibility when using a screen reader while reading
              the docs, we recommend using Firefox and NVDA, or Safari and
              VoiceOver.
            </p>
          </>
        }
